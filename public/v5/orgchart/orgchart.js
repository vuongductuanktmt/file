  ...
  OrgChart.prototype = {
    ...
    createNode: function (data) {
      ...
      var $nodeDiv = $('<div' + (opts.draggable ? ' draggable="true"' : '') + (data[opts.nodeId] ? ' id="' + data[opts.nodeId] + '"' : '') + (data.parentId ? ' data-parent="' + data.parentId + '"' : '') + '>')
        .addClass(name_node + (data.className || '') +  (level > opts.visibleLevel ? ' slide-up' : ''));
      if (opts.nodeTemplate) {
        $nodeDiv.append(opts.nodeTemplate(data));
      } else {
        if(data.level>2 && typeof data.children != "undefined" && data.children.length>0){
          if(data[opts.nodeTitle].length < 14){
            $nodeDiv.append('<div class="title" id="title-'+position+'" style="line-height: 42px;"><span>' + data[opts.nodeTitle] + '</span></div>')
                .append("<hr class='chart-line'/>")
              .append(typeof opts.nodeContent !== 'undefined' ? '<div class="content"><i class="fa fa-times-circle content-ico" style="float:left;margin-left:5px;"></i><img class="img-circle content-img" src="' + ((typeof data.children[0] != "undefined")?data.children[0][opts.nodeContent] : '') + '"><img class="img-circle content-img-2" src="' + ((typeof data.children[1] != "undefined")?data.children[1][opts.nodeContent] : '') +'"><div class="content-img-3">+1</div><i class="fa fa-plus-circle content-ico" style="float:right;margin-right:5px;"></i></div>':'');
          }
          else{
            $nodeDiv.append('<div class="title" id="title-'+position+'"><span>' + data[opts.nodeTitle] + '</span></div>')
                .append("<hr class='chart-line'/>")
            .append(typeof opts.nodeContent !== 'undefined' ? '<div class="content"><i class="fa fa-times-circle content-ico" style="float:left;margin-left:5px;"></i><img class="img-circle content-img" src="' + ((typeof data.children[0] != "undefined")?data.children[0][opts.nodeContent] : '') + '"><img class="img-circle content-img-2" src="' + ((typeof data.children[1] != "undefined")?data.children[1][opts.nodeContent] : '') +'"><div class="content-img-3">+1</div><i class="fa fa-plus-circle content-ico" style="float:right;margin-right:5px;"></i></div>':'');
          }
         }else{
          if(data[opts.nodeTitle].length < 14) {
              $nodeDiv.append('<div class="title" id="title-' + position + '" style="line-height: 42px;"><span>' + data[opts.nodeTitle] + '</span></div>')
                  .append("<hr class='chart-line'/>")
                  .append(typeof opts.nodeContent !== 'undefined' ? '<div class="content"><i class="fa fa-times-circle content-ico" style="float:left;margin-left:5px;"></i><img class="img-circle content-img" src="' + (data[opts.nodeContent] || '') + '"><i class="fa fa-plus-circle content-ico" style="float:right;margin-right:5px;"></i></div>' : '');
          }
          else{
              $nodeDiv.append('<div class="title" id="title-' + position + '"><span>' + data[opts.nodeTitle] + '</span></div>')
                  .append("<hr class='chart-line'/>")
      ...
      if (opts.verticalLevel && level >= opts.verticalLevel) {
        ...
        if (Number(flags.substr(0,1))) {
          // Hide this icon follow request QC
