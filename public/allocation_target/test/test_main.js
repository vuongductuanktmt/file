...
describe("test logic premission edit kpi",function(){
    //var kpi = JSON.parse('{"disable_edit":false,"current_quarter":3,"ten_KPI":"Tài chính","year":"","months_target":{"quarter_1":{"month_1":"","month_2":"","month_3":""},"quarter_2":{"month_1":"","month_2":"","month_3":""},"quarter_3":{"month_1":"","month_2":"","month_3":""},"quarter_4":{"month_1":"","month_2":"","month_3":""}},"quarter_1":"","quarter_2":"","quarter_3":"","quarter_4":"","isGroup":true,"score_calculation_type":"","year_data":{},"visible2":false,"name_kpi_parent":"","code":"","group":"","weight":0,"unit":"","current_goal":"","operator":"","assigned_to":"","data_source":"","edit":"","yeardata":""}')
    it("logic",function(){
        var result_array_login = [true,true,false,false,false,false,false,false,false]
        var input_array_login =[
            {
                is_user_system :true,
                enable_edit: false,
            ...
            },
            {
                ...
                enable_edit: true,
                allow_edit_monthly_target: true,
                enable_to_edit: true
            },
            {
                is_user_system :false,
        ...
        for (var i = 0; i <input_array_login.length; i++) {
            assert.equal(JSON.stringify(targetPage.pemission_edit_kpi(input_array_login[i])), JSON.stringify(result_array_login[i]))
        }
    })
})